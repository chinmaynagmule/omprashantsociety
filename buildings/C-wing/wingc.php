...
<body>
    <div class="wrapper">
        ...
        <div class="residentheader">
                <h3>List of Residents - Wing C</h3>
            </div>
          ...
          $display= "select * from residential where wing='C' && floor='1' ";
         ...
         ?>
            ...
            <table class="table table-hover">
              ...
              <?php
            $con = mysqli_connect("localhost", "root", "", "ompdb");
          $display= "select * from residential where wing='C' && floor='2' ";
          $query= mysqli_query($con,$display);
         if(mysqli_num_rows($query) > 0)
         {
          while($result= mysqli_fetch_array($query)){
         ...
         ?>
           ...
           <table class="table table-hover">
             ...
             <?php
           $con = mysqli_connect("localhost", "root", "", "ompdb");
         $display= "select * from residential where wing='C' && floor='3' ";
         $query= mysqli_query($con,$display);
        if(mysqli_num_rows($query) > 0)
        {
         while($result= mysqli_fetch_array($query)){
        ...
        ?>
           ...
           <table class="table table-hover">
             ...
             <?php
           $con = mysqli_connect("localhost", "root", "", "ompdb");
         $display= "select * from residential where wing='C' && floor='4' ";
         $query= mysqli_query($con,$display);
        if(mysqli_num_rows($query) > 0)
        {
         while($result= mysqli_fetch_array($query)){
