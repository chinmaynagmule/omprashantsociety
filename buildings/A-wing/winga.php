    ...
    <div class="wrapper">
        ...
        <div class="fram_floor">
            <div class="residentheader">
                <h3>List of Residents - Wing A</h3>
            </div>
          ...
          $display= "select * from residential where wing='A' && floor='1' ";
         ...
         ?>
            ...
            <table class="table table-hover">
              ...
              <?php
            $con = mysqli_connect("localhost", "root", "", "ompdb");
          $display= "select * from residential where wing='A' && floor='2' ";
          $query= mysqli_query($con,$display);
         if(mysqli_num_rows($query) > 0)
         {
          while($result= mysqli_fetch_array($query)){
         ...
         ?>
           ...
           <table class="table table-hover">
             ...
             <?php
           $con = mysqli_connect("localhost", "root", "", "ompdb");
         $display= "select * from residential where wing='A' && floor='3' ";
         $query= mysqli_query($con,$display);
        if(mysqli_num_rows($query) > 0)
        {
         while($result= mysqli_fetch_array($query)){
        ...
        ?>
           ...
           <table class="table table-hover">
             ...
             <?php
           $con = mysqli_connect("localhost", "root", "", "ompdb");
         $display= "select * from residential where wing='A' && floor='4' ";
         $query= mysqli_query($con,$display);
        if(mysqli_num_rows($query) > 0)
        {
         while($result= mysqli_fetch_array($query)){
