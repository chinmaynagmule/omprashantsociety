...
<body>
    <div class="wrapper">
        ...
        <div class="credentials">
            ...
            <h4 style="text-align:center">Enter New Notices Here</h4>
            <br>
        <form>
  <div class="form-group">
    <label for="name">Notice:</label>
    <textarea class="form-control" id="notice" name="notice" rows="3" placeholder="Enter Notice Here" required></textarea>
  </div>
