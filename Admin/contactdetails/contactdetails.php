...
<body>
    <div class="wrapper">
        ...
        <div class="credentials">
            ...
            <h4 style="text-align:center">Enter Society Ofiicials Details Here</h4>
            <br>
        <form>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="designation" placeholder="Enter Position" required>
  </div>
  <div class="form-group">
